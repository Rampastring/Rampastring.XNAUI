...
namespace Rampastring.XNAUI.DXControls
{
    ...
    public class DXMultiColumnListBox : DXPanel
    {
        ...
        public void AddColumn(DXPanel header, DXListBox listBox)
        {
            ...
            header.ClientRectangle = new Rectangle(width - 1, 0, header.ClientRectangle.Width, header.ClientRectangle.Height);

            headers.Add(header);
            AddChild(header);

            listBox.ClientRectangle = new Rectangle(width - 1, header.ClientRectangle.Bottom - 1,
        ...
        public override void Initialize()
        {
            ...
            foreach (DXPanel header in headers)
                width += header.ClientRectangle.Width - 1;
            ...
            foreach (ListBoxColumn column in columns)
            {
                ...
                if (DrawListBoxBorders)
                    headerPanel.ClientRectangle = new Rectangle(width, 0, column.Width + 1, header.ClientRectangle.Height + 3);
                else
